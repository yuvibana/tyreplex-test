...
function AppHeader() {
  return (
    <header className='appHeader py-2  border-b border-gray-200'>
      <nav className='headerFlex container flex justify-between items-center'>
        <Link to='/' className='logo'>
          <img src={Logo} />
        </Link>
        <ul className='navMenu lg:flex block gap-5'>
          <div className='mbHeader lg:hidden flex p-2 justify-between border-b border-gray-200'>
            <Link to='/' className='logo'>
              <img src={Logo} />
            </Link>
            <span className='closeIcons'><IoCloseSharp className='text-5xl' /></span>
          </div>
        ...
        <div className='headerRightSide flex items-center gap-8'>
          ...
          <div className='humIcon lg:hidden block'> <RiMenu3Fill className='text-3xl' /> </div>
        </div>
      </nav>
    </header>
  )
